/*
To do
1. Regulation for each data field in the data vault
*/
...
struct ConsumerAgency{
    ...
    // mapping(address => AdharHolder[]) AdhartoAgency;
    // this will be a dictionary that will store the aadhar no. and name of the aadhar holder unique to the agency
}
